...
alias mvn='JAVA_HOME="C:/Program Files/Amazon Corretto/jdk11.0.7_10" \
  $OPT/apache-maven-3/bin/mvn'
alias java='"C:/Program Files/Amazon Corretto/jdk11.0.7_10/bin/java"'
...
alias jconsole='"C:/Program Files/Amazon Corretto/jdk11.0.7_10/bin/jconsole"'
...
alias tf='docker run --rm -it --name terraform hashicorp/terraform:0.12.15 terraform'
