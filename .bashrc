...
alias mvn='JAVA_HOME="C:/Program Files/Amazon Corretto/jdk11.0.6_10" \
  $OPT/apache-maven-3/bin/mvn'
alias java='"C:/Program Files/Amazon Corretto/jdk11.0.6_10/bin/java"'
...
alias jconsole='"C:/Program Files/Amazon Corretto/jdk11.0.6_10/bin/jconsole"'
alias avro-tools='java -jar $OPT/apache-avro-1.9/avro-tools-1.9.1.jar'
#alias winpty='$OPT/winpty-0.4.2-cygwin-2.6.1-ia32/bin/winpty'
alias python='$LOCALAPPDATA/Programs/Python/Python38/python.exe'
...
alias tf='docker run --rm -it --name terraform hashicorp/terraform:0.12.8 terraform'
